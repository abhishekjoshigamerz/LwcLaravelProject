...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Add Comics Code here </h1> 
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-lg-12 ">
                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form method="POST" action="{{ 'createcomics' }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="inputState">Add Flipbook link here</label>

                              <div class="input-group">
                                <textarea name="flipbooklink" id="" class="form-control" row="20"></textarea>
                              </div>
                            </div>
                            <div class="form-group">
