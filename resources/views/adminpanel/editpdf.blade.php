...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Edit Comics Pdf here </h1> 
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Edit Comics </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12 ">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Edit Comics</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form method="POST" action="{{ url('adminpanel/updatepdfcomics') }}" enctype="multipart/form-data">
                    
                    {{ csrf_field() }}
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Comics Name</label>
                        <input type="text" class="form-control"  name="comicsname"  id="exampleInputEmail1" value="{{$data->comics_name}}" placeholder="Comics Name" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Comics Tag</label>
                        <input type="text" name="comicstag"  class="form-control" value=
                        "{{$data->comics_tags_for_search}}" id="exampleInputPassword1" placeholder="Enter a tag, for example for class 5 science just write class 5 science or if maths write class 5 maths." required>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="hidden" name="pdfID" value="{{$data->pdfcomics_id}}" />
                            <div class="form-group">
                              <label for="inputState">Add Comics Description here</label>

                              <div class="input-group">
                                <textarea name="comics_description" id="textarea"   class="form-control" row="20">{{$data->comic_description}}</textarea>
                              </div>
                            </div>
                      </div>
