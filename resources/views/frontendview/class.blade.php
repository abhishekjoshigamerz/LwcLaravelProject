                    ...
                    <ul class="products thumb-info-list">
                        ...
                        <li class="col-md-3 product">
                            ...
                            <span class="thumb-info">
                                <a href="{{url('class')}}/{{$item->class_slug}}" class="add-to-cart-product">
                                <span><i class="icon icon-shopping-cart"></i> {{$item->class_name}}</span>
                                </a>
                                <a href="{{url('class')}}/{{$item->class_slug}}">
                                ...
                                <img alt="img" class="img-responsive" src="{{URL::asset('uploads/regularcomics.png')}}">
                                </span>
                                </a>
