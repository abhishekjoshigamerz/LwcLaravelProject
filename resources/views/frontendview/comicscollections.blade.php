						...
						<ul class="products thumb-info-list">
                           ...
                           <li class="col-md-3 product">
                               ...
                               <span class="thumb-info">
                                   <a href="{{url('/comicread/pdfcomics')}}/{{$record->url_slug}}" class="add-to-cart-product">
                                   ...
                                   <img alt="img" class="img-responsive" src="{{url('uploads/')}}/{{$record->comics_thumbnail}}">
                                   </span>
                                   </a>
                                   <span class="thumb-info-content">
                                       <a href="{{url('/comicread/pdfcomics')}}/{{$record->url_slug}}">
                                        <?php 
                                        $string = strip_tags($record->comics_name);
                                    if (strlen($string) > 15) {
