    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <h1 class="text-center">Latitude Longitude</h1>
            </div>
            <!-- Content Column -->
                            ...
                            <div class="content white-bg pt-30">
                                ...
                                <div class="course-overview">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9" >
                                        ...
                                        <iframe src="https://drive.google.com/file/d/1ThNAGOT61efzmOJu891PmP9ZStlMs7-v/preview" width="640" height="480"></iframe>
                                                                                                                                       </div>  </div>  
                                    </div>                                                
                            </div>
                        </div>
